...
public class Driver {
    ...
    public static WebDriver getDriver() {
        ...
        //mustafasahin:i added that to clear cookies to get rid of translation error of page
...
//    Driver.selectByIndex(dropdown element, "91303")
    ...
    public static void waitForOptionsOfSelectPopulate(By elementBy){
        WebDriverWait wait = new WebDriverWait(Driver.getDriver(), Duration.ofSeconds(timeout));
        wait.until(
                ExpectedConditions
                        .presenceOfElementLocated(elementBy));
    }
    public static void waitForOptionsOfSelectPopulate(By elementBy,int timeouts){
        WebDriverWait wait = new WebDriverWait(Driver.getDriver(), Duration.ofSeconds(timeouts));
        wait.until(
                ExpectedConditions
                        .presenceOfElementLocated(elementBy));
    }
